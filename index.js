...
if (process.env.GCM_SENDER_ID && process.env.GCM_API_KEY) {
    pushConfig['android'] = { senderId: process.env.GCM_SENDER_ID || '403340014632',
                              apiKey: process.env.GCM_API_KEY || 'AIzaSyBeXG4Jgj-PAmy_HrMwUTwd5iBnxinEbRo'};
}
...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'http://herokutpushtest.herokuapp.com/parse'  // needed for Parse Cloud and push notifications
});
